  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-slate-50 via-emerald-50/30 to-green-50/40 text-slate-900 antialiased overflow-hidden font-['Syne',sans-serif]">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        ...
        <div className="absolute inset-0 opacity-50 [mask-image:linear-gradient(to_right,black_0%,black_25%,rgba(0,0,0,0.7)_50%,rgba(0,0,0,0.4)_75%,transparent_100%)]">
          <DotGrid
            dotSize={6}
            gap={18}
            baseColor="#1f2937"
      ...
      <header className="sticky top-4 z-40 mx-auto max-w-7xl px-6">
        <div className="backdrop-blur-md bg-white/90 border-2 border-[#1f7a1a] rounded-2xl p-4 flex items-center justify-between shadow-md">
